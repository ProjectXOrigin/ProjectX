...
AProjectXCharacter::AProjectXCharacter()
{
	...
	PistolHandler = CreateDefaultSubobject<UChildActorComponent>(TEXT("PistolHandler"));
	PistolHandler->SetupAttachment(FP_MuzzleLocation);
...
void AProjectXCharacter::BeginTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
void AProjectXCharacter::EndTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
//void AProjectXCharacter::TouchUpdate(const ETouchIndex::Type FingerIndex, const FVector Location)
//{
...
bool AProjectXCharacter::EnableTouchscreenMovement(class UInputComponent* PlayerInputComponent)
{
	if (FPlatformMisc::SupportsTouchInput() || GetDefault<UInputSettings>()->bUseMouseForTouch)
	{
		PlayerInputComponent->BindTouch(EInputEvent::IE_Pressed, this, &AProjectXCharacter::BeginTouch);
		PlayerInputComponent->BindTouch(EInputEvent::IE_Released, this, &AProjectXCharacter::EndTouch);

		//Commenting this out to be more consistent with FPS BP template.
		//PlayerInputComponent->BindTouch(EInputEvent::IE_Repeat, this, &AProjectXCharacter::TouchUpdate);
		return true;
	}
